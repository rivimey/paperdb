...
<ul>
  ...
  <li><a href="fixup_text.php?f=1">Fix up incorrectly coded text in tables</a></li>
</ul>
<p>Specialist functions</p>
<ul>
  <li><a href="list_proceeds.php?f=4">Export database as BibTex, plain-text</a></li>
  <li><a href="list_proceeds.php?f=5">Export database as Refer, plain-text</a></li>
</ul>
<p>Quit</p>
<ul>
