...
?>
  ...
  <? if ($edit) { ?>
    ...
    <tr> 
      <td>ID:</td>
      <td><input type="text" readonly name="num" value="<?=$edit?$person['personid']:'' ?>" /></td>
    </tr>
  <? } ?>
    <tr> 
      <td>Title:</td>
      <td><input type="text" name="title" value="<?=$edit?$person['title']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>First Name:</td>
      <td><input type="text" name="firstname" value="<?=$edit?$person['firstname']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Surname: *</td>
      <td><input type="text" name="lastname" value="<?=$edit?$person['lastname']:'' ?>" /></td>
    </tr>
    <tr> 
      <td colspan="2"><small>Warning: Entering information about living people that is not publicly
      published will probably render the database subject to registration under EU Data Protection
      legislation.</small></td>
    </tr>
    <tr> 
      <td>Address 1:</td>
      <td><input type="text" name="address1" value="<?=$edit?$person['address1']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Address 2:</td>
      <td><input type="text" name="address2" value="<?=$edit?$person['address2']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Address 3:</td>
      <td><input type="text" name="address3" value="<?=$edit?$person['address3']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>City:</td>
      <td><input type="text" name="city" value="<?=$edit?$person['city']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Area:</td>
      <td><input type="text" name="area" value="<?=$edit?$person['area']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Country:</td>
      <td><input type="text" name="country" value="<?=$edit?$person['country']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Organisation:</td>
      <td> 
    ...
    <tr> 
      <td>Email Address:</td>
      <td><input type="text" name="email" value="<?=$edit?$person['email']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Homepage URL:</td>
      <td><input type="text" name="homepage" value="<?=$edit?$person['homepage']:'' ?>" /></td>
    </tr>
    <tr> 
      <td>Notes:</td>
      <td><input type="textarea" name="notes" value="<?=$edit?$person['notes']:'' ?>" /></td>
    </tr>
    <tr> 
      <td colspan="2" align="center"> <input type="submit" value="<?=$edit?"Update":"Insert"?>" /></td>
    </tr>
    <tr> 
  </table>
</form>
...
?>
  ...
  <tr>
   ...
   <tr>
     <td>Totpages:</td>
     <td><input size=6 type=text name=totpages value="<?=$edit?$proceeding["totpages"]:""; ?>" /></td>
   </tr>
